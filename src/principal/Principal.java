...
public class Principal {
	public static void main(String[] args) {	
		...
		long tiempo;
		int resul;
		Persona persona = new Persona(Algoritmos.cedulaAleatorio(), Algoritmos.aleatorio(60, 100));
		...
		Ordenacion.bubbleSort(personasCopia1);
		...
		Ordenacion.seleccion(personasCopia2);
		tiempo = System.nanoTime()-tiempo;
		System.out.println("Tiempo Ejecucion: " + tiempo + " nanosegundos");
		...
		Ordenacion.insercion(personasCopia3);
		tiempo = System.nanoTime() - tiempo;
		System.out.println("Tiempo Ejecucion: " + tiempo + " nanosegundos");
		...
		tiempo = System.nanoTime() - tiempo;
      	System.out.println(personas + (resul == -1 ? "Dato No Encontrado" : "Dato Encontrado En La Posicion: " + resul));
    	System.out.println("Tiempo Ejecucion: " + tiempo + " nanosegundos\n");
	...
	public static Persona[] generarPersonas(int n) {
		...
		for (int i = 0; i < vector.length; i++) {
			vector[i] = new Persona(Algoritmos.cedulaAleatorio(), Algoritmos.aleatorio(60, 100));
		}
